    ...
    <div className="container md:max-w-xl mx-auto px-4 md:px-10 bg-white/20 rounded-3xl py-12 backdrop-blur-sm max-w-[96%]">
      ...
      {verificationResult === null ? (
        ...
        <div className="w-full flex flex-col items-center gap-4">
          ...
          <button 
            onClick={handleReset}
            className="md:w-full w-max bg-black text-white inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-primary text-primary-foreground hover:bg-slate-500 h-10 px-4 py-2"
          >
            Reset
          </button>
        </div>
