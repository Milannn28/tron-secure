...
const howTronsecureWork = () => {
  return (
    <div className="py-24 bg-gradient-to-b from-white to-purple-50">
                      <div className="container px-4 mx-auto">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-16 text-gray-900" >How TronSecure Works</h2>
                        ...
                        <div className="relative grid md:grid-cols-3 gap-8">
                            <div className="relative" >
                                ...
                                <div className="bg-white p-6 rounded-xl shadow-lg cursor-pointer transition-all ring-2 ring-purple-500">
                                    <h3 className="text-xl font-semibold mb-2 text-center text-gray-900">Wallet Check</h3>
                            ...
                            <div className="relative" >
                                <div className="w-20 h-20 rounded-full flex items-center justify-center mb-6 mx-auto bg-white border-2 transition-colors duration-300 shadow-lg border-purple-200 text-purple-300">
                                ...
                                <div className="bg-white p-6 rounded-xl shadow-lg cursor-pointer transition-all">
                                    <h3 className="text-xl font-semibold mb-2 text-center text-gray-900">Join Waitlist</h3>
                            ...
                            <div className="relative">
                                ...
                                <div className="bg-white p-6 rounded-xl shadow-lg cursor-pointer transition-all">
                                    <h3 className="text-xl font-semibold mb-2 text-center text-gray-900">Access Platform</h3>
...
export default howTronsecureWork
