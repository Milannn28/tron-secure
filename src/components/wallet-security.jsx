...
export default function WalletSecurity() {
    ...
    const data = [
        {
            ...
            "svg": <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-search h-6 w-6">
                <circle cx="11" cy="11" r="8"></circle>
                <path d="m21 21-4.3-4.3"></path>
            </svg>,
            "items": [
                "Cross-reference with major exchanges",
        ...
        },
        {
            ...
            "svg": <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-triangle-alert h-6 w-6">
        ...
        {
            "title": "Trust Network",
            "svg": <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-network h-6 w-6">
            ...
            "items": [
                "Shared with major exchanges",
                "Verified wallet recognition",
                "Enhanced trading privileges",
            ]
        },
        {
            "title": "Digital Certificate",
            "svg": <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-award h-6 w-6">
    ...
    return (
        <div ref={ref} id="security" className='py-24 bg-gradient-to-b from-purple-100 to-white'>
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <motion.h2
                        className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 uppercase font-oswald"
                        initial={{ opacity: 0.5, y: 10 }}
                        animate={inView ? { opacity: 1, y: 0 } : {}}
                        transition={{ duration: 0.2 }}
                    >
                        Premium Wallet Security Report
                    </motion.h2>
                                    ...
                                    <div className="p-6 bg-white  rounded-xl">
                                        <div className="flex items-start space-x-4">
                                            ...
                                            <div className="grid text-start ">
                                                <h4 className="text-lg font-semibold text-gray-900 mb-4 font-oswald uppercase">{items.title}</h4>
                                                <ul className="space-y-3">
                                                    {items.items.map((data_item) => (
                ...
                <motion.div
                    className="rounded-xl bg-purple-600 p-6 md:p-8"
