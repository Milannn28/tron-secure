    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          {/* Logo */}
          <a className="flex items-center space-x-2" href="/" onClick={closeMobileMenu}>
            <svg
          ...
          >
            <div className="flex flex-col md:flex-row gap-2 md:gap-8 md:items-center items-start">
              <a className="text-gray-600 hover:text-purple-600 transition-colors flex items-center space-x-1" 
                 href="/#features" 
              ...
              <a className="text-gray-600 hover:text-purple-600 transition-colors flex items-center space-x-1" 
                 href="/#frenquenty-asked-questions" 
                 onClick={closeMobileMenu}>
            ...
            <a href="/dashboard" onClick={closeMobileMenu} className="w-full md:w-fit">
