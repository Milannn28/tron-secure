    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <nav
            className={`absolute md:relative gap-2 top-20 md:top-0 left-0 w-full md:w-auto justify-between  bg-white md:bg-transparent shadow-md md:shadow-none p-4 md:p-0 flex flex-col md:flex-row items-center md:space-x-8 transition-all duration-300 ${
